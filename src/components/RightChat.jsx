...
function RightChat() {
    ...
    return (
        <div id="main-content-wrap" className={`right-chat nav-wrap mt-2 right-scroll-bar ${width > 1600 ? "active-sidebar" : " "}`}>
            ...
            <div className={isOpen ? "modal-popup-chat d-block" : "modal-popup-chat"}>
                <div className="modal-popup-wrap bg-white p-0 shadow-lg rounded-3">
                    ...
                    <div className="modal-popup-body w-100 p-3 h-auto">
                        ...
                        <div className="snippet pt-3 ps-4 pb-2 pe-3 mt-2 bg-grey rounded-xxxl float-right" data-title=".dot-typing"><div className="stage"><div className="dot-typing"></div></div></div>
                        <div className="clearfix"></div>
                    </div>
                    <div className="modal-popup-footer w-100 border-top">
                        <div className="card p-3 d-block border-0 d-block">
                            <div className="form-group icon-right-input style1-input mb-0"><input type="text" placeholder="Start typing.." className="form-control rounded-xxxl bg-greylight border-0 font-xssss fw-500 ps-3" /><i className="feather-send text-grey-500 font-md"></i></div>
                        </div>
                    </div>
                </div>
            </div>
