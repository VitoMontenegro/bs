            ...
            {groupList.map((value , index) => (
                <div className="wrap" key={index}>
                    ...
                    <div className="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                        <a href="/defaultgroup" className="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xxxl"><i className="feather-external-link font-xss me-2"></i> Like Page</a>
                    </div>
                </div>
